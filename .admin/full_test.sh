...
echo "Run DSE Tests"
echo "---------------------------------------------"
export MAVEN_OPTS="-Djavax.net.ssl.trustStorePassword=cassandra -Djavax.net.ssl.trustStore=/home/jturner131/git/github/tmobile/casquatch/.admin/dsessl/.truststore -Djavax.net.ssl.trustStoreType=jks"
...
cassandraDriver.ssl.truststore.path=/home/jturner131/git/github/tmobile/casquatch/config/client.truststore
